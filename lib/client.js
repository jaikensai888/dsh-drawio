...
function NewDiagramIcon({ size = 16 }) {
...
function NewDiagramButton({ ctx }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
		...
		disabled,
		title: scope === void 0 ? "当前没有活跃会话，无法确定工作区" : error !== null ? `新建图纸失败：${error}` : "在当前工作区的 docs/diagrams/ 下新建一张空白图纸",
		"aria-label": "新建图纸",
		style: {
			display: "inline-flex",
			alignItems: "center",
		...
		children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(NewDiagramIcon, {}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: busy ? "新建中…" : "新建图纸" })]
	});
}
...
function apply(ctx) {
	...
	}, () => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(NewDiagramButton, { ctx }))));
}
