...
function NewDiagramButton({ ctx, wide = true }) {
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		disabled,
		title: scope === void 0 ? "新建图纸：当前没有活跃会话，无法确定工作区" : error !== null ? `新建图纸失败：${error}` : `新建图纸：在当前工作区新建一张空白图纸`,
		"aria-label": "新建图纸",
		"aria-busy": busy,
		style: {
			display: "inline-flex",
		...
		children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(NewDiagramIcon, { size: wide ? RAIL_ICON_PX_WIDE : RAIL_ICON_PX_NARROW })
	});
}
