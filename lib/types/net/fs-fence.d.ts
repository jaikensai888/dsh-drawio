 ...
 */
export declare function resolveWithinBase(base: string, candidate: string, label?: string): string;
/**
 ...
 */
export declare function resolveRequestPath(base: string, raw: unknown, label?: string): string;
